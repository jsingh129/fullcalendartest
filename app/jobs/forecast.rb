...
forecast_api_key = "6801a77b4bb261a3ba41c6f2bec347d8"

# Latitude, Longitude for location
forecast_location_lat = "49.282729"
forecast_location_long = "-123.120738"
...
Dashing.scheduler.every '5m', :first_in => 0 do |job|
  ...
  Dashing.send_event('forecast', { temperature: "#{forecast_current_temp}&deg;", hour: "#{forecast_hour_summary}"})
end